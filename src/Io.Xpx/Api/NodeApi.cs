...
namespace Io.Xpx.Api
{
    ...
    public interface INodeApi : IApiAccessor
    {
        ...
        ApiResponse<NodeInfo> GetNodeInfoPeersUsingGETWithHttpInfo ();
        /// <summary>
        /// Get Storage Node Information
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<NodeInfo> GetNodeInfoPeersUsingGETAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<NodeInfo>> GetNodeInfoPeersUsingGETAsyncWithHttpInfo ();
        /// <summary>
        /// Get Storage Node Information
        /// </summary>
        /// <remarks>
    ...
    public partial class NodeApi : INodeApi
    {
        ...
        /// <exception cref="Io.Xpx.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>NodeInfo</returns>
        public NodeInfo GetNodeInfoPeersUsingGET ()
        {
             ApiResponse<NodeInfo> localVarResponse = GetNodeInfoPeersUsingGETWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        /// <exception cref="Io.Xpx.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of NodeInfo</returns>
        public ApiResponse< NodeInfo > GetNodeInfoPeersUsingGETWithHttpInfo ()
        {

            var localVarPath = "/node/info/peers";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetNodeInfoPeersUsingGET", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <exception cref="Io.Xpx.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of NodeInfo</returns>
        public async System.Threading.Tasks.Task<NodeInfo> GetNodeInfoPeersUsingGETAsync ()
        {
             ApiResponse<NodeInfo> localVarResponse = await GetNodeInfoPeersUsingGETAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="Io.Xpx.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (NodeInfo)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<NodeInfo>> GetNodeInfoPeersUsingGETAsyncWithHttpInfo ()
        {
