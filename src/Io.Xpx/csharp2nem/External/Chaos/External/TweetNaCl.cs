...
namespace TweetNaCl
{
    public class TweetNaCl
    {
        ...
        internal static void Pack(Byte[] r, Int64[][] /*gf*/ p/*[4]*/)
        {
        ...
        internal static void Scalarmult(Int64[][] /*gf*/ p /*[4]*/ , Int64[][] /*gf*/ q /*[4]*/, Byte[] s, Int32 sOffset)
        {
            Set25519(p[0], GF0);
            Set25519(p[1], GF1);
            Set25519(p[2], GF1);
        ...
        internal static Int32 Unpackneg(Int64[][] /*gf*/ r/*[4]*/, Byte[] p/*[32]*/)
        {
        ...
        internal static Int64[] GF = new Int64[GF_LEN];
